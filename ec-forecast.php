...
'Ottawa (Kanata - Orl�ans), ON|https://weather.gc.ca/city/pages/on-118_metric_e.html',
'Montr�al, QC|https://weather.gc.ca/city/pages/qc-147_metric_e.html',
...
if ($Lang == 'fr') {
  ...
  $ECHEAD = 'Pr�visions';
  $abnormalString = '<p class="ECforecast"><strong>*</strong> - Indique une tendance inverse de la temp�rature.</p>' . "\n";
} else {
  $Lang = 'en';
  $LMode = 'e';
...
'fr'=> array(
  ...
  'citycondition' => 'Condition',
  'obsdate' => 'Date',
  'cityobserved' => 'Enregistr�es �',
  'temperature' => 'Temp�rature',
  'pressure' => 'Pression',
  'tendency' => 'Tendance',
  'humidity' => 'Humidit�',
  'windchill' => 'Refr.<br/>�olien',
  'windchillabbr' => 'refroidissement �olien',
  'humidex' => 'Humidex',
  ...
  'norms' => 'Normales',
	'issued'  => '�mises �',
	'extremeMax' => 'Temp�rature la plus �lev�e',
	'extremeMin' => 'Temp�rature la plus basse',
	'normalMax' => 'Temp�rature maximale moyenne',
	'normalMin' => 'Temp�rature minimale moyenne',
	'normalMean' => 'Temp�rature moyenne',
	'extremeRainfall' => 'Pluie maximale',
	'extremeSnowfall' => 'Neige maximale',
	'extremePrecipitation' => 'Pr�cipitation maximale',
	'extremeSnowOnGround' => 'Maximum de neige au sol',
	'almanacpop' => 'Fr�quence mensuelle de pr�cipitation',
  'avgexhead'  => 'Moyennes et extr�mes',
	'na' => 'n.d.',
	'forecast24' => 'Pr�visions 24 heures',
  'datetime' => 'Date/Heure',
  'temperature' => 'Temp',
  'weatherconds' => 'Condition m�t�o',
  'lop' => 'EdP &dagger;',
  'wind' => 'Vents',
  'lopnote' => '&dagger; �ventualit� de pr�cipitation (EdP) mesurable, indiqu� dans la pr�vision '.
	  'publique comme probabilit� de pr�cipitation pour une p�riode de temps.<br/>' .
    '&nbsp;&nbsp;Nulle: 0%<br/>' .
...
(
    [station] => Aéroport int. Munro de Hamilton
    [dateTime] => Array
        (
...
(
    [cityobserved] => Observed at: <strong>Montr�al-Trudeau Int'l Airport</strong>
...
/*
    ...
    [textSummary] => Partiellement nuageux avec 40 pour cent de probabilité d'averses. Risque d'un orage tôt ce soir. Nappes de brouillard se formant au cours de la nuit. Minimum 17.
    [cloudPrecip] => SimpleXMLElement Object
        (
            [textSummary] => Partiellement nuageux avec 40 pour cent de probabilité d'averses. Risque d'un orage tôt
ce soir.
        )
    ...
    [abbreviatedForecast] => SimpleXMLElement Object
        (
            [iconCode] => 39
            [pop] => 40
            [textSummary] => Possibilité d'averses
        )
...
// set the legend
$weather7days = ($Lang=='fr')?'Pr�visions':'Extended Forecast';
